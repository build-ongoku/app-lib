import { ITypeMinimal } from "../core/app";
...
export const convertFullTypeToInput = <T extends ITypeMinimal>(
  fullType: WithMetaFields<T>
): T => {
...
export const convertTypeToWithMeta = <T extends ITypeMinimal>(
  fullType: T
): WithMetaFields<T> => {
  // add the meta fields
  const metaFields = {
