...
import { getEntityDetailPath } from 'goku.static/components/EntityLink'
import { Link, redirect } from 'react-router-dom'
import React, { CSSProperties, useState } from 'react'
import { useGetEntity, useUpdateEntity } from 'goku.static/providers/provider'

import { TypeFormItems } from 'goku.static/components/Form'
...
export const DefaultEditView = <E extends EntityMinimal>(props: Props<E>) => {
    ...
    if (!loading && !error && data) {
        ...
        return <Link to={getEntityDetailPath({ entityInfo, entity })} />
    }
