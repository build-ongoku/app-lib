import { EntityInfo, EntityInfoCommon } from 'goku.static/common/Entity'
import { EntityInfoCommonV2, EntityMinimal, EntityProps } from 'goku.static/common/Entity'
import { TypeInfoCommon } from 'goku.static/common/Type'
